...
/*
	Funziona al pari di una open. Prende 3 variabili in ingresso, ossia id, type e open_mode e 
	restituisce invece un file descriptor fd. Una volta creato un file descriptor fd lo aggiunge 
	inoltre nella lista dei descrittori aperti (running->descriptors) e ne aggiunge il relativo 
	puntatore alla lista dei puntatori di descrittori
*/
